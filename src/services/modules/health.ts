...
export function circuitDot(circuit: CircuitState): 'success' | 'warning' | 'danger' {
...
export const healthApi = {
  ...
  onHealthChanged: (cb: () => void): Promise<UnlistenFn> => subscribe(Events.endpointHealthChanged, () => cb()),
}
