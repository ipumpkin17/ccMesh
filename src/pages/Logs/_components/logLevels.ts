...
const LEVEL_TONE: Record<LogLevel, LevelTone> = {
  ...
  DEBUG: {
    ...
    dot: 'bg-sky-500',
    chipIdle: 'border-sky-500/30 text-sky-700/90 hover:bg-sky-500/10 dark:text-sky-300/90',
    chipActive: 'border-sky-500/50 bg-sky-500/12 text-sky-700 dark:text-sky-300',
  },
  TRACE: {
    badge: 'border-transparent bg-violet-500/12 text-violet-700 dark:text-violet-300',
    dot: 'bg-violet-500',
    chipIdle: 'border-violet-500/30 text-violet-700/90 hover:bg-violet-500/10 dark:text-violet-300/90',
    chipActive: 'border-violet-500/50 bg-violet-500/12 text-violet-700 dark:text-violet-300',
  },
}
