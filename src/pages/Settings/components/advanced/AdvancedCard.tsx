...
export function AdvancedCard({ cfg, save }: { cfg: AppConfig; save: (patch: Record<string, string>) => Promise<void> }) {
  ...
  const syncLocalUa = async (target: 'openai' | 'claude') => {
      ...
      <SettingsRow
        ...
        control={
          <SettingsTextField
            ...
            actionLabel="读取本机"
            onAction={() => void syncLocalUa('openai')}
      ...
      <SettingsRow
        ...
        control={
          <SettingsTextField
            ...
            actionLabel="读取本机"
            onAction={() => void syncLocalUa('claude')}
            actionPending={readingLocal}
          />
        }
      />
