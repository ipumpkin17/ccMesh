...
export function GeneralCard({
  ...
  return (
    <SettingsSection title="常规设置">
      <SettingsRow title="主题" description="选择应用界面的配色方案" control={
      ...
      <SettingsRow title="定时自动切换主题" description="按设定时间自动切换浅色与深色主题" control={
        <Switch
      ...
      {cfg.themeAuto && (
        <SettingsRow title="浅色 / 深色起始时间" description="设置两种主题的自动切换时间" control={
          <SettingsControls>
      ...
      <SettingsRow title="语言" description="设置应用的显示语言" control={
        <SettingsControl width="md">
        <Select
          value={cfg.language}
          onValueChange={(v) => {
      ...
      <SettingsRow title="关闭窗口行为" description="选择关闭窗口后的默认处理方式" control={
        <SettingsControl width="md">
        <Select
      ...
      <SettingsRow title="导航布局" description="选择侧边或顶部导航布局" control={
        <SettingsControl width="md">
      ...
      <SettingsRow title="日志级别" description="控制运行日志的详细程度" control={
        <SettingsControl width="md">
        <Select
          value={cfg.logLevel}
          onValueChange={(v) => {
