...
export function StartupCard({
  ...
  return (
    <SettingsSection title="启动行为">
      <SettingsRow title="代理端口" description="本地代理服务监听端口" control={
      ...
      <SettingsRow title="自启动" description="跟随系统自启动" control={
        <Switch
      ...
      <SettingsRow title="静默启动" description="后台启动，启动时不展示窗口，常驻托盘运行" control={
        <Switch
      ...
      <SettingsRow title="自动运行" description="应用打开时自动启动代理服务" control={
        <Switch
          checked={cfg.autoRun}
