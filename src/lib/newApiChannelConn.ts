...
const PLACEHOLDER_EXAMPLE = '{"_type":"newapi_channel_conn","key":"sk-...","url":"https://www.example.com"}'
...
export function nameFromUpstreamUrl(rawUrl: string): string {
  ...
  const withoutCommonPrefix = labels[0] === 'www' || labels[0] === 'api' ? labels.slice(1) : labels
...
function readRequiredString(obj: Record<string, unknown>, field: 'key' | 'url'): string {
