...
vi.mock("@lobehub/icons", () => {
  ...
  const brands = [
    "Aws", "Azure", "Cerebras", "Claude", "Cloudflare", "Cohere", "Codex",
    ...
    "OpenRouter", "Perplexity", "Qwen", "Replicate", "SambaNova", "SiliconCloud",
    "Spark", "Stepfun", "Together", "Volcengine", "Wenxin", "XiaomiMiMo", "Yi", "Zhipu",
  ];
