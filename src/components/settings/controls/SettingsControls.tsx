...
export function SettingsTextField({
  ...
  return (
    <div className="flex h-9 min-w-0 overflow-hidden rounded-sm border border-input bg-surface-raised">
      <Input
      ...
      <Button
        size="sm"
        variant="outline"
        className="h-full rounded-none border-0 border-l border-input bg-surface-card px-4 shadow-none hover:bg-surface-hover"
